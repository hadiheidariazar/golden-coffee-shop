                        ...
                        getSearchLocation ? (
                            <div className="ticket-info bg-gray-200/50 dark:bg-zinc-800 w-full p-4 rounded-lg">
                                <h4 className='text-sm/5 sm:text-base/5 pb-3 border-b-[1px] border-b-gray-400/50'>
                                   یک متن تستی بدون معنی برای موضوع تیکت
                                </h4>
                                <div className='mt-4'>
                                    <div className="bg-white dark:bg-zinc-700 p-3 w-[85%] sm:w-[500px] rounded-tl-xl rounded-bl-xl rounded-br-xl">
                                        <h4 className='text-sm font-dana-bold line-clamp-1'> هادی حیدری آذر </h4>
                                        <p className='text-xs dark:text-gray-300'>1402/12/25</p>
                                        <p className='text-xs/4 xs:text-sm/5 mt-1'>
                                            سلام
                                            <br />
                                            ما برآنیم تا با پیشرو بودن در فرآیند تولید، نوع و کیفیت محصول، خدمات و توزیع، الگویی برای تولیدکنندگان ایرانی باشیم ما برآنیم تا با پیشرو بودن در فرآیند تولید، نوع و کیفیت محصول، خدمات و توزیع، الگویی برای تولیدکنندگان ایرانی باشیم
                                        </p>
                                    </div>
                                </div>
